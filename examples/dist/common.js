...
function checkPropTypes(componentName, propTypes, props, location) {
  var propTypeType = arguments.length <= 4 || arguments[4] === undefined ? "propType" : arguments[4];
  var addendum = arguments.length <= 5 || arguments[5] === undefined ? "" : arguments[5];
  ...
  for (var propName in propTypes) {
    if (propTypes.hasOwnProperty(propName)) {
      ...
      try {
        ...
        (0, _fbjsLibInvariant2['default'])(typeof propTypes[propName] === 'function', '%s: %s type `%s` is invalid; it must be a function, usually from ' + 'React.PropTypes.', componentName || 'React class', ReactPropTypeLocationNames[location], propName);
      ...
      if (error instanceof Error && !(error.message in loggedTypeFailures)) {
        ...
        (0, _fbjsLibWarning2['default'])(false, 'Failed %s: %s %s', propTypeType, error.message, addendum);
      }
    }
  }
}
...
module.exports = exports['default'];
},{"fbjs/lib/invariant":2,"fbjs/lib/warning":3}],7:[function(require,module,exports){
'use strict';
...
exports['default'] = computeStylesFromState;
...
function satisfies(state) {
  return function (propString) {
    var propNames = propString.split(':').filter(function (p) {
      return !!p;
    });
...
function computeStylesFromState(_ref) {
  ...
  var satisfiesState = satisfies(state);

  return (0, _arrayify2['default'])(styles).filter(function (s) {
    return ['string', 'function', 'object'].indexOf(typeof s) > -1;
  }).reduce(function (computedStyles, style) {
    if (!style) {
    ...
    if (styleType === 'function') {
      computedStyles.push.apply(computedStyles, _toConsumableArray(computeStylesFromState({
        styles: style(state),
        state: state
      })));
      return computedStyles;
    ...
    (0, _arrayify2['default'])(base).forEach(function (base) {
    ...
    var _Object$keys$reduce = Object.keys(style).reduce(function (keys, k) {
      if (/::/.test(k)) {
    ...
    var topLevel = _Object$keys$reduce.topLevel;
    var conditionals = _Object$keys$reduce.conditionals;
    var pseudoElements = _Object$keys$reduce.pseudoElements;

    var topLevelStyles = topLevel.reduce(function (result, k) {
    ...
    conditionals.filter(satisfiesState).forEach(function (k) {
      var value = getValue(style, k, state);

      if (Array.isArray(value)) {
        computedStyles.push.apply(computedStyles, _toConsumableArray(value));
      } else {
        computedStyles.push(value);
      }
    });

    pseudoElements.map(splitPseudoElementString).filter(function (_ref2) {
      var _ref22 = _slicedToArray(_ref2, 2);

      var k = _ref22[0];
      var propString = _ref22[1];
      ...
      var k = _ref32[0];
      var _ = _ref32[1];
      var pseudoElementName = _ref32[2];

      computedStyles.push(_defineProperty({}, pseudoElementName, getValue(style, k, state)));
    });
...
module.exports = exports['default'];
},{"./arrayify":5}],8:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, '__esModule', {
  value: true
});
exports['default'] = getInvalidStyleStates;
function isBool(propTypeFunction) {
  // HACKish:
  return !propTypeFunction({ a: true }, 'a');
}

function getInvalidStyleStates(_ref) {
  var _ref$style = _ref.style;
  var style = _ref$style === undefined ? {} : _ref$style;
  var _ref$styleStateTypes = _ref.styleStateTypes;
  var styleStateTypes = _ref$styleStateTypes === undefined ? {} : _ref$styleStateTypes;

  var invalids = Object.keys(Object.keys(style).filter(function (k) {
    return (/^:[^:]/.test(k)
    );
  }).reduce(function (invalids, propName) {
    var styleStateNames = propName.split(/:/).filter(function (n) {
      return n.length > 0;
    });

    styleStateNames.forEach(function (styleStateName) {
...
exports["default"] = getInvalidSubComponents;

function getInvalidSubComponents(_ref) {
  var subComponents = _ref.subComponents;
  var subComponentTypes = _ref.subComponentTypes;

  if (!subComponentTypes || !subComponents) {
    return;
  }

  var invalids = Object.keys(subComponents.reduce(function (invalids, subComponentName) {
...
exports['default'] = getSubComponentStyles;

function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function getSubComponentStyles(_ref) {
  ...
  return styles.reduce(function (result, style) {
    ...
    var sorted = Object.keys(style).reduce(function (subResult, propName) {
      ...
      if (/::/.test(propName)) {
        ...
        if (/^::/.test(propName)) {
          ...
          var subComponentIndicatorIdx = propName.indexOf('::');
          var selector = propName.substr(0, subComponentIndicatorIdx);
          subComponentName = propName.substr(subComponentIndicatorIdx + 2);
          value = _defineProperty({}, selector, value);
        }
    ...
    Object.keys(sorted).forEach(function (subComponentName) {
...
function isReactClass(component) {
  return component && (component instanceof _react.Component || component.isReactClass || component.prototype && component.prototype.isReactComponent);
}
...
function _mergeStyles() {
  ...
  styles.forEach(function (style) {
    ...
    if (typeofStyle !== 'object') {
      if (depth === 0 && typeofStyle === 'string') {
        style.split(/\s+/).forEach(function (className) {
    ...
    Object.keys(style).forEach(function (key) {
      ...
      var idx = inlineStyleKeys.indexOf(key);
      if (idx > -1) {
  ...
  return {
    ...
    style: inlineStyleKeys.reduce(function (result, key) {
...
exports['default'] = validateStyles;
...
var _getSubComponentStyles = require('./getSubComponentStyles');

var _getSubComponentStyles2 = _interopRequireDefault(_getSubComponentStyles);

var _getInvalidStyleStates = require('./getInvalidStyleStates');

var _getInvalidStyleStates2 = _interopRequireDefault(_getInvalidStyleStates);

var _getInvalidSubComponents = require('./getInvalidSubComponents');

var _getInvalidSubComponents2 = _interopRequireDefault(_getInvalidSubComponents);

var stringifyPropertyList = function stringifyPropertyList(styleStates) {
  return styleStates.map(function (s) {
    return '`' + s + '`';
  }).join(', ');
};

function validateStyles(_ref, displayName, props, propName, component) {
  var styleStateTypes = _ref.styleStateTypes;
  var subComponentTypes = _ref.subComponentTypes;

  var subComponentStyles = (0, _getSubComponentStyles2['default'])({
    styles: (0, _arrayify2['default'])(props.styles)
  }) || {};

  var invalidStyleStates = (0, _getInvalidStyleStates2['default'])({
    // We're only worried about root styles:
    style: (0, _mergeStyles2['default'])(subComponentStyles.root),
    styleStateTypes: styleStateTypes
  });

  var errors = [];

  if (invalidStyleStates) {
    var errorIntro = invalidStyleStates.length > 1 ? '[' + stringifyPropertyList(invalidStyleStates) + '] are not valid style-states of `' + (displayName || component) + '`.' : stringifyPropertyList(invalidStyleStates) + ' is not a valid style-state of `' + (displayName || component) + '`.';

    errors.push(errorIntro + ' ' + 'Valid style-states are: [' + stringifyPropertyList(Object.keys(styleStateTypes)) + '].');
  }

  delete subComponentStyles.root;

  var invalidSubComponents = (0, _getInvalidSubComponents2['default'])({
    subComponents: Object.keys(subComponentStyles),
    subComponentTypes: subComponentTypes
  });

  if (invalidSubComponents) {
    var errorIntro = invalidSubComponents.length > 1 ? '[' + stringifyPropertyList(invalidSubComponents) + '] are not valid sub-components of `' + (displayName || component) + '`.' : stringifyPropertyList(invalidSubComponents) + ' is not a valid sub-component of `' + (displayName || component) + '`.';

    errors.push(errorIntro + ' ' + 'Valid sub-components are: [' + stringifyPropertyList(Object.keys(subComponentTypes)) + '].');
  }
...
module.exports = exports['default'];
},{"./arrayify":5,"./getInvalidStyleStates":8,"./getInvalidSubComponents":9,"./getSubComponentStyles":10,"./mergeStyles":12}],14:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSProperty":16,"./ReactPerf":84,"./dangerousStyleValue":117,"fbjs/lib/ExecutionEnvironment":142,"fbjs/lib/camelizeStyleName":144,"fbjs/lib/hyphenateStyleName":155,"fbjs/lib/memoizeStringOnly":162,"fbjs/lib/warning":167}],18:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":35,"./PooledClass":36,"fbjs/lib/invariant":156}],19:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Danger":24,"./ReactMultiChildUpdateTypes":80,"./ReactPerf":84,"./setInnerHTML":136,"./setTextContent":137,"fbjs/lib/invariant":156}],22:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":156}],23:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMProperty":22,"./ReactPerf":84,"./quoteAttributeValueForBrowser":134,"fbjs/lib/warning":167}],24:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/ExecutionEnvironment":142,"fbjs/lib/createNodesFromMarkup":147,"fbjs/lib/emptyFunction":148,"fbjs/lib/getMarkupWrap":152,"fbjs/lib/invariant":156}],25:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventPluginRegistry":29,"./EventPluginUtils":30,"./ReactErrorUtils":69,"./accumulateInto":115,"./forEachAccumulated":122,"fbjs/lib/invariant":156,"fbjs/lib/warning":167}],29:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":156}],30:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":27,"./ReactErrorUtils":69,"fbjs/lib/invariant":156,"fbjs/lib/warning":167}],31:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":27,"./EventPluginHub":28,"./accumulateInto":115,"./forEachAccumulated":122,"fbjs/lib/warning":167}],32:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactPropTypeLocations":86,"./ReactPropTypes":87,"fbjs/lib/invariant":156,"fbjs/lib/warning":167}],35:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":156}],37:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactInstanceMap":75,"./findDOMNode":120,"fbjs/lib/warning":167}],39:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactReconciler":89,"./instantiateReactComponent":130,"./shouldUpdateReactComponent":138,"./traverseAllChildren":139,"fbjs/lib/warning":167}],41:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":35,"./ReactComponent":43,"./ReactElement":65,"./ReactNoopUpdateQueue":82,"./ReactPropTypeLocationNames":85,"./ReactPropTypeLocations":86,"fbjs/lib/emptyObject":149,"fbjs/lib/invariant":156,"fbjs/lib/keyMirror":159,"fbjs/lib/keyOf":160,"fbjs/lib/warning":167}],43:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactNoopUpdateQueue":82,"fbjs/lib/emptyObject":149,"fbjs/lib/invariant":156,"fbjs/lib/warning":167}],44:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":156}],46:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":35,"./ReactComponentEnvironment":45,"./ReactCurrentOwner":47,"./ReactElement":65,"./ReactInstanceMap":75,"./ReactPerf":84,"./ReactPropTypeLocationNames":85,"./ReactPropTypeLocations":86,"./ReactReconciler":89,"./ReactUpdateQueue":95,"./shouldUpdateReactComponent":138,"fbjs/lib/emptyObject":149,"fbjs/lib/invariant":156,"fbjs/lib/warning":167}],47:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./AutoFocusUtils":14,"./CSSPropertyOperations":17,"./DOMProperty":22,"./DOMPropertyOperations":23,"./EventConstants":27,"./Object.assign":35,"./ReactBrowserEventEmitter":39,"./ReactComponentBrowserEnvironment":44,"./ReactDOMButton":49,"./ReactDOMInput":54,"./ReactDOMOption":55,"./ReactDOMSelect":56,"./ReactDOMTextarea":60,"./ReactMount":78,"./ReactMultiChild":79,"./ReactPerf":84,"./ReactUpdateQueue":95,"./escapeTextContentForBrowser":119,"./isEventSupported":131,"./setInnerHTML":136,"./setTextContent":137,"./validateDOMNesting":140,"fbjs/lib/invariant":156,"fbjs/lib/keyOf":160,"fbjs/lib/shallowEqual":165,"fbjs/lib/warning":167}],51:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":65,"./ReactElementValidator":66,"fbjs/lib/mapObject":161}],52:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMChildrenOperations":21,"./DOMPropertyOperations":23,"./ReactMount":78,"./ReactPerf":84,"fbjs/lib/invariant":156}],54:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./LinkedValueUtils":34,"./Object.assign":35,"./ReactDOMIDOperations":53,"./ReactMount":78,"./ReactUpdates":96,"fbjs/lib/invariant":156}],55:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":35,"./ReactChildren":41,"./ReactDOMSelect":56,"fbjs/lib/warning":167}],56:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./LinkedValueUtils":34,"./Object.assign":35,"./ReactMount":78,"./ReactUpdates":96,"fbjs/lib/warning":167}],57:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMChildrenOperations":21,"./DOMPropertyOperations":23,"./Object.assign":35,"./ReactComponentBrowserEnvironment":44,"./ReactMount":78,"./escapeTextContentForBrowser":119,"./setTextContent":137,"./validateDOMNesting":140}],60:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./LinkedValueUtils":34,"./Object.assign":35,"./ReactDOMIDOperations":53,"./ReactUpdates":96,"fbjs/lib/invariant":156,"fbjs/lib/warning":167}],61:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":35,"./ReactCurrentOwner":47}],66:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":47,"./ReactElement":65,"./ReactPropTypeLocationNames":85,"./ReactPropTypeLocations":86,"./getIteratorFn":127,"fbjs/lib/invariant":156,"fbjs/lib/warning":167}],67:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactRootIndex":91,"fbjs/lib/invariant":156}],75:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
module.exports = React;
},{"./Object.assign":35,"./ReactChildren":41,"./ReactClass":42,"./ReactComponent":43,"./ReactDOMFactories":51,"./ReactElement":65,"./ReactElementValidator":66,"./ReactPropTypes":87,"./ReactVersion":97,"./onlyChild":133}],77:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactChildReconciler":40,"./ReactComponentEnvironment":45,"./ReactCurrentOwner":47,"./ReactMultiChildUpdateTypes":80,"./ReactReconciler":89,"./flattenChildren":121}],80:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":35,"fbjs/lib/invariant":156}],82:[function(require,module,exports){
/**
...
},{"fbjs/lib/warning":167}],83:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":156}],84:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactDefaultBatchingStrategy":61,"./ReactElement":65,"./ReactInstanceHandles":74,"./ReactMarkupChecksum":77,"./ReactServerBatchingStrategy":92,"./ReactServerRenderingTransaction":94,"./ReactUpdates":96,"./instantiateReactComponent":130,"fbjs/lib/emptyObject":149,"fbjs/lib/invariant":156}],94:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":35,"./ReactCurrentOwner":47,"./ReactElement":65,"./ReactInstanceMap":75,"./ReactUpdates":96,"fbjs/lib/invariant":156,"fbjs/lib/warning":167}],96:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CallbackQueue":18,"./Object.assign":35,"./PooledClass":36,"./ReactPerf":84,"./ReactReconciler":89,"./Transaction":113,"fbjs/lib/invariant":156}],97:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":35,"./PooledClass":36,"fbjs/lib/emptyFunction":148,"fbjs/lib/warning":167}],106:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":156}],114:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/invariant":156}],116:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":35,"fbjs/lib/warning":167}],119:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":47,"./ReactInstanceMap":75,"./ReactMount":78,"fbjs/lib/invariant":156,"fbjs/lib/warning":167}],121:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./traverseAllChildren":139,"fbjs/lib/warning":167}],122:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":35,"./ReactCompositeComponent":46,"./ReactEmptyComponent":67,"./ReactNativeComponent":81,"fbjs/lib/invariant":156,"fbjs/lib/warning":167}],131:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":65,"fbjs/lib/invariant":156}],134:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":47,"./ReactElement":65,"./ReactInstanceHandles":74,"./getIteratorFn":127,"fbjs/lib/invariant":156,"fbjs/lib/warning":167}],140:[function(require,module,exports){
/**
 * Copyright 2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":35,"fbjs/lib/emptyFunction":148,"fbjs/lib/warning":167}],141:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 *
...
},{"./emptyFunction":148,"_process":4}],"react-input-autosize":[function(require,module,exports){
'use strict';
...
},{"react":"react"}],"react-seamstress":[function(require,module,exports){
(function (process){
'use strict';
...
var _computeStylesFromState = require('./computeStylesFromState');

var _computeStylesFromState2 = _interopRequireDefault(_computeStylesFromState);

var _getSubComponentStyles = require('./getSubComponentStyles');

var _getSubComponentStyles2 = _interopRequireDefault(_getSubComponentStyles);

var _validateStyles = require('./validateStyles');

var _validateStyles2 = _interopRequireDefault(_validateStyles);

var _checkPropTypes = require('./checkPropTypes');
...
function overrideWithWarning(object, propertyName, value, displayName) {
  if (__DEV__) {
    ...
    (0, _fbjsLibWarning2['default'])(!Object.prototype.hasOwnProperty.call(object, propertyName), '`' + displayName + '` is automatically provided by Seamstress. ' + 'The original definition will be overridden.');
  }
...
function configureSeamstress() {
  var config = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
  var _config$styles = config.styles;
  var styles = _config$styles === undefined ? {} : _config$styles;
  var styleStateTypes = config.styleStateTypes;
  var _config$getStyleState = config.getStyleState;
  var getStyleState = _config$getStyleState === undefined ? function (_) {} : _config$getStyleState;

  var __subComponentTypes = config.subComponentTypes || {};
  var subComponentTypes = Object.assign({}, __subComponentTypes, {
  ...
  function styleizeComponent(useHoc, Component) {
    ...
    var validateComponentStyles = _validateStyles2['default'].bind(null, config, displayName);

    if (__DEV__) {
      var error = validateComponentStyles({ styles: styles }, 'styles');
      (0, _fbjsLibWarning2['default'])(!error, (error ? error.message : 'Unexpected Error') + (' Check the `styles` property supplied to the Seamstress config of `' + displayName + '`.'));
    }

    function getComputedStyles(_ref) {
      var props = _ref.props;
      var context = _ref.context;
      var state = _ref.state;

      var styleState = getStyleState({ props: props, context: context, state: state });

      if (__DEV__) {
        var addendum = 'Check the `getStyleState()` function supplied to the Seamstress config of `' + displayName + '`.';

        (0, _fbjsLibWarning2['default'])(!styleState.hasOwnProperty('base'), '`:base` is a reserved styleState that is always `true`; please use a different name. ' + addendum);

        if (styleStateTypes) {
          (0, _checkPropTypes2['default'])(displayName, styleStateTypes, styleState, 'prop', 'styleStateType', addendum);
        }
      }
      ...
      var computedStyles = (0, _getSubComponentStyles2['default'])({
        styles: (0, _computeStylesFromState2['default'])({
          state: styleState,
          styles: [].concat(_toConsumableArray((0, _arrayify2['default'])(styles)), _toConsumableArray((0, _arrayify2['default'])(props.styles)), [props.className, props.style])
        })
      });

      var allSubComponentNames = Object.keys(Object.assign({}, computedStyles, subComponentTypes));

      allSubComponentNames.forEach(function (name) {
        if (subComponentTypes[name] === SubComponentTypes.composite) {
          computedStyles[name] = { styles: computedStyles[name] || [] };
        } else {
          computedStyles[name] = (0, _mergeStyles2['default'])(computedStyles[name] || {});
        }
      });
    ...
    function extendStyles(myStyles) {
      var newConfig = Object.assign({}, config, {
        styles: [].concat(_toConsumableArray((0, _arrayify2['default'])(styles)), _toConsumableArray((0, _arrayify2['default'])(myStyles)))
      });
    ...
    function wrap(Component) {
      return (function (_React$Component) {
        _inherits(SeamstressComponent, _React$Component);

        function SeamstressComponent() {
          _classCallCheck(this, SeamstressComponent);

          _get(Object.getPrototypeOf(SeamstressComponent.prototype), 'constructor', this).apply(this, arguments);
        }

        _createClass(SeamstressComponent, [{
          key: 'render',
          value: function render() {
            ...
            return _react2['default'].createElement(Component, _extends({}, props, {
              computedStyles: getComputedStyles({ props: props, context: context })
            }));
          }
        }], [{
          key: 'propTypes',
    ...
    if (useHoc) {
      ...
      var thisGetComputedStyles = function thisGetComputedStyles() {
        var props = this.props;
        var context = this.context;
        var state = this.state;

        return getComputedStyles({ props: props, context: context, state: state });
      };

      if (!(0, _isReactClass2['default'])(Component)) {
        ...
        newComponent = (function (_Component) {
          ...
          _createClass(_class, null, [{
            key: 'propTypes',
            value: Object.assign({}, Component.propTypes),
            enumerable: true
          }]);
...
var SubComponentTypes = {
  simple: '__Seamstress_SubComponentTypes_simple__',
  composite: '__Seamstress_SubComponentTypes_composite__'
};

exports.SubComponentTypes = SubComponentTypes;
exports.mergeStyles = _mergeStyles2['default'];
...
exports['default'] = Seamstress;
}).call(this,require('_process'))
},{"./arrayify":5,"./checkPropTypes":6,"./computeStylesFromState":7,"./getSubComponentStyles":10,"./isReactClass":11,"./mergeStyles":12,"./validateStyles":13,"_process":4,"fbjs/lib/warning":3,"react":"react"}],"react":[function(require,module,exports){
'use strict';
